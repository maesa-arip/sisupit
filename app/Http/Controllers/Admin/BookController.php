...
class BookController extends Controller
{
    ...
    {
        $books = Book::query()
            ->select(['id', 'book_code', 'title', 'slug', 'cover', 'author', 'publication_year', 'isbn', 'language', 'number_of_pages', 'status', 'price', 'category_id', 'publisher_id', 'created_at'])
    ...
    public function edit(Book $book): Response
    {
        return inertia('Admin/Books/Edit', [
            'page_settings' => [
                'title' => 'Edit Buku',
                'subtitle' => 'Edit buku disini. Klik simpan setelah selesai',
                'method' => 'PUT',
