...
class ReturnBookController extends Controller
{
    ...
    public function create(Loan $loan): Response|RedirectResponse
    {
        ...
        return inertia('Admin/ReturnBooks/Create', [
            'page_settings' => [
                ...
                'subtitle' => 'Kembalikan buku yang dipinjam disisni. Klik kembalikan setelah selesai.',
                'method' => 'POST',
    ...
    public function store(Loan $loan, Request $request): RedirectResponse
    {
        try {
            DB::beginTransaction();
            ...
            if ($isOnTime) {
                ...
                flashMessage('Berhasil mengambalikan buku');
        ...
        switch ($returnBookCheck->condition->value) {
            ...
            default:
                if ($daysLate > 0) {
                    ...
                    return [
                        'message' => 'Terlambat mengambalikan buku dan  harus membayar denda keterlambatan',
                    ];
                } else {
                    $returnBook->update([
