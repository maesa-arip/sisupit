...
import { IconArrowsDownUp, IconPencil, IconPlus, IconRefresh, IconTrash, IconBrandProducthunt } from '@tabler/icons-react';
...
export default function Index(props) {
	...
	UseFilter({
		route: route('front.products.index'),
		values: params,
		only: ['products'],
	});
		...
		<div className="flex flex-col w-full pb-32">
			<div className="flex flex-col items-start justify-between mb-8 gap-y-4 lg:flex-row lg:items-center">
				...
				<Button variant="orange" size="sm" asChild>
					<Link href={route('front.products.create')}>
									...
									<TableCell>
										<div className="flex items-center gap-x-1">
											<Button variant="blue" size="sm" asChild>
												<Link href={route('front.products.edit', [product])}>
											...
											<AlertDialog>
												...
												<AlertDialogContent>
													...
													<AlertDialogFooter>
														...
														<AlertDialogAction
															onClick={() =>
																router.delete(route('front.products.destroy', [product]), {
																	preserveScroll: true,
																	preserveState: true,
																	onSuccess: (success) => {
