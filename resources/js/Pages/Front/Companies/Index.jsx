...
import { IconArrowsDownUp, IconBuilding, IconCategory, IconPencil, IconPlus, IconRefresh, IconTrash } from '@tabler/icons-react';
import { useState } from 'react';
import { toast } from 'sonner';

export default function Index(props) {
	const { data: companies, meta } = props.companies;
	...
	UseFilter({
		route: route('front.companies.index'),
		values: params,
		only: ['companies'],
	});
	return (
		<div className="flex flex-col w-full pb-32">
			<div className="flex flex-col items-start justify-between mb-8 gap-y-4 lg:flex-row lg:items-center">
				...
				<Button variant="orange" size="sm" asChild>
					<Link href={route('front.companies.create')}>
									...
									<TableCell>
										<div className="flex items-center gap-x-1">
											<Button variant="blue" size="sm" asChild>
												<Link href={route('front.companies.edit', [company])}>
												...
												<AlertDialogContent>
													...
													<AlertDialogFooter>
														...
														<AlertDialogAction
															onClick={() =>
																router.delete(
																	route('front.companies.destroy', [company]),
																	{
																		preserveScroll: true,
																		preserveState: true,
																		onSuccess: (success) => {
