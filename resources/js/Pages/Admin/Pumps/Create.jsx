...
export default function Create({ tenant_location, provinces, cities, districts, admin_level, admin_region_names }) {
	...
	const handleLockedClick = () =>
		toast.error('Wewenang Terbatas: Anda tidak dapat mengubah atau menambah data di luar yurisdiksi wilayah tugas Anda.');
...
Create.layout = (page) => <AppLayout children={page} title="Registrasi Pompa" />;
