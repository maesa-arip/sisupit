...
export default function Edit({ agency, category_options = [], incident_types = [] }) {
	const { data, setData, put, processing, errors } = useForm({
		...
		default_incident_types: agency.default_incident_types || [],
		requires_confirmation: Boolean(agency.requires_confirmation),
						...
						<form className="space-y-5" onSubmit={onHandleSubmit}>
							<div className="flex items-start gap-3 rounded-md border border-info/20 bg-info/10 p-3 text-info">
								...
								<p className="text-xs font-medium leading-relaxed">
									Insiden yang sudah melibatkan OPD ini menyimpan salinan nama & kalimat konfirmasinya
									sendiri, jadi catatan lama tidak ikut berubah saat Anda menyunting di sini.
								</p>
							</div>
...
Edit.layout = (page) => <AppLayout children={page} title="Ubah OPD" />;
