		...
		<div className="flex flex-col w-full pb-32 space-y-4">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>Menpilkan rincian semua denda member</CardDescription>
				</CardHeader>
			...
			<div className="grid gap-4 md:gap-8 lg:grid-cols-2">
                ...
                <div className='grid gap-4 md:gap-8 lg:grid-cols-1'>
                    <CardStatDescription
                        title="Sudah Dibayar"
                        description="Denda yang sudah berhasil dibayar"
                    >
                        <div className='flex items-baseline gap-2 text-3xl font-bold leading-none text-orange-500 tabular-nums'>
                            {formatToRupiah(props.page_data.fine_paid)}
                        </div>
                    </CardStatDescription>
                    <CardStatDescription
                        title="Belum Dibayar"
                        description="Denda yang belum berhasil dibayar"
                    >
                        <div className='flex items-baseline gap-2 text-3xl font-bold leading-none text-orange-500 tabular-nums'>
