...
export default function Edit(props) {
	...
	const { data, setData, reset, post, processing, errors } = useForm({
		...
		village_code: props.user.village_code || props.admin_level?.village_code || '',
	...
	const getHelperText = () => {
		...
		if (props.admin_level?.city_code)
			return 'Wewenang Kabupaten/Kota: Anda dapat menempatkan pengguna ini di tingkat Kecamatan hingga Desa.';
		if (props.admin_level?.province_code)
			return 'Wewenang Provinsi: Anda dapat menempatkan pengguna ini di tingkat Kabupaten hingga Desa.';
		return 'Wewenang Pusat: Anda dapat menempatkan pengguna ini di seluruh wilayah Indonesia.';
	};
