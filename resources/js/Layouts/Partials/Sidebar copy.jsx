		...
		<nav className="grid items-start px-2 text-sm font-semibold lg:px-4">
			...
			<>
				...
				<NavLink
					...
					active={url.startsWith('/dashboard2')}
					title="Dashboard 2"
					icon={IconDashboard}
				/>
				...
				{/* <Dialog open={open} onOpenChange={setOpen}>
					<DialogTrigger asChild>
						<Button
							...
							className="justify-start w-full gap-3 py-6 font-bold text-left rounded-xl bg-amber-50 text-amber-700 hover:bg-amber-100 dark:bg-amber-900/20 dark:text-amber-400 dark:hover:bg-amber-900/40"
						>
